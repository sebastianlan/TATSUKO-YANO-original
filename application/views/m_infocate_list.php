...
<div class="marginbottom10">
	<a class="btn btn-success" href="<?php echo site_url('info/addCate')?>" role="button"><i class="fa fa-plus"></i> Add category</a>
</div>
...
<form id="myform" action="<?php echo site_url('info/updateCateOrder')?>" method="post">
		...
		<table class="table table-striped table-bordered table-hover <!--text-center-->">
			...
			if (empty ( $infocatelist )) {
				...
				foreach ( $infocatelist as $v ) {
					...
					<td><a href="<?php echo site_url('info/editCate/'.$v['id'])?>"
						class="btn btn-xs btn-info" role="button"> <i class="fa fa-edit"></i> Edit </a> &nbsp;&nbsp;
                        <a href="javascript:if(confirm('Are you sure you want to delete ?')){window.location.href='<?php echo site_url('info/deleteCate/'.$v['id'].'/'.$offset)?>';}"

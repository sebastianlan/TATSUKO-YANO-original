...
<div class="marginbottom10">
	<a class="btn btn-success" href="<?php echo site_url('news/add')?>" role="button"><i class="fa fa-plus"></i> Add news</a>
</div>
...
<form id="myform" action="<?php echo site_url('news/updateOrder')?>" method="post">
	<div class="table-responsive">
		<table class="table table-striped table-bordered table-hover <!--text-center-->">
			<thead>
				<tr>
					<th width="9%">Order<i class="fa fa-refresh pull-right"
						style="margin-top: 3px; cursor: pointer;" data-toggle="tooltip"
			...
			if (empty ( $newslist )) {
				...
				foreach ( $newslist as $v ) {
					...
					<td><a href="<?php echo site_url('news/edit/'.$v['id'])?>"
						class="btn btn-xs btn-info" role="button"> <i class="fa fa-edit"></i> Edit </a> &nbsp;&nbsp;
                        <a href="javascript:if(confirm('Are you sure you want to delete ?')){window.location.href='<?php echo site_url('news/delete/'.$v['id'].'/'.$offset)?>';}"

...
<div class="marginbottom10">
	<a class="btn btn-success" href="<?php echo site_url('group/add')?>" role="button"><i class="fa fa-plus"></i> Add partner</a>
</div>
...
<form id="myform" action="<?php echo site_url('group/updateOrder')?>" method="post">
		...
		<table class="table table-striped table-bordered table-hover <!--text-center-->">
			...
			if (empty ( $grouplist )) {
				...
				foreach ( $grouplist as $v ) {
					...
					<td><a href="<?php echo site_url('group/edit/'.$v['id'])?>"
						class="btn btn-xs btn-info" role="button"> <i class="fa fa-edit"></i> Edit </a> &nbsp;&nbsp;
                        <a href="javascript:if(confirm('Are you sure you want to delete ?')){window.location.href='<?php echo site_url('group/delete/'.$v['id'].'/'.$offset)?>';}"
